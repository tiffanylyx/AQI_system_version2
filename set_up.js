...
.attr("class","new_svg")
    .attr("transform", `translate(${0},${fall_area_height+10})`);
var img_height = (width2 + margin2.left + margin2.right)/imageRatio
...
svg2.append("rect")
    ...
    .attr("y", fall_area_height+10+y_axis_length-img_height)
    .attr("opacity",0.2)
// set the dimensions and margins of the graph
